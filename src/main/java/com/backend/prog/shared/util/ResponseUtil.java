package com.backend.prog.shared.util;

import com.backend.prog.shared.error.CommonExceptionDto;
...
public class ResponseUtil {
    ...
    public void setErrorResponse(HttpServletResponse response, ExceptionEnum exceptionEnum)
        ...
        CommonExceptionDto commonExceptionDto = new CommonExceptionDto(exceptionEnum.getCode(),
