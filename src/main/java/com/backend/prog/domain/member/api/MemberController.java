...
public class MemberController {
    ...
    public void updateProfile(@RequestPart("member") @Valid MemberDto.ProfilePatch memberDto,
    ...
    public Object getMyProfile(Principal principal) {
        MemberDto.Response response = memberService.getMyProfile(
    ...
    public void isUniqueNickName(@PathVariable(required = false) Integer id,
        @RequestBody @Valid MemberDto.nicknamePost memberDto, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new CommonException(ExceptionEnum.INVALID_MEMBER_DATA);
        }
    ...
    public void changePassword(@RequestBody @Valid MemberDto.PasswordPatch memberDto,
        BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new CommonException(ExceptionEnum.INVALID_MEMBER_DATA);
        }
    ...
    public void sendAuthCode(@RequestBody @Valid MemberDto.emailPost memberDto,
        BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new CommonException(ExceptionEnum.INVALID_MEMBER_DATA);
        }
    ...
    public void verifyAuthCode(@RequestBody MemberDto.emailVerificationPost memberDto,
        BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new CommonException(ExceptionEnum.INVALID_MEMBER_DATA);
        }
    ...
    public void withdrawalMember(HttpServletRequest request, HttpServletResponse response,
