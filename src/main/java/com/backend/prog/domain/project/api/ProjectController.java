...
//
//        Page<ProjectDto.SimpleResponse> response = projectService.getProjects(id, keyword,
//            techCodes, statusCode, pageable);
//
//        return response;
//    }
//
...
//        @RequestParam(value = "file", required = false) MultipartFile file) {
//
//        AdditionalDto.Response responses = additionalService.updateAdditional(additionalId,
//            memberId, patch, file);
//    }
//
...
//        @PathVariable("member-id") Integer memberId) {
//
//        List<ApplicationStatusDto.Response> responses = applicationStatusService.getApplications(
//            projectId, memberId);
//
//        return responses;
//    }
...
//
//        List<ProjectMemberDto.Response> responses = projectMemberService.getProjectMembers(
//            projecId);
//
//        return responses;
//    }
...
//    public List<MyProjectResponse> getMyProjects(@PathVariable("member-id") Integer memberId,
//        @PathVariable("status-code") Integer statusCode) {
//        return projectService.getMyProjects(memberId, statusCode);
//    }
//
//    @GetMapping("myproject-signed/{member-id}")
//    public List<MyProjectResponse> getSignedMyProjects(
//        @PathVariable("member-id") Integer memberId) {
...
//    public ProjectHomeResponse getProjectHome(@PathVariable("projectId") Long projectId,
//        @PathVariable("memberId") Integer memberId) {
//        return projectService.getProjectHome(projectId, memberId);
//    }
//
//    @GetMapping("home/project-member/{projectId}")
//    public List<ProjectHomeMemberResponse> getProjectHomeMember(
